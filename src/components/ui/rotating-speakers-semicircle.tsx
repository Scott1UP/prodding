...
const RING_CONFIG = [
  { radiusPct: 0.17, duration: 20, sizes: [[55,79],[60,86],[58,82],[62,89],[56,82],[60,84],[55,79],[59,85]] as const, radius: 5 },
...
interface RotatingSpeakersSemicircleProps {
  speakers: Speaker[]
  className?: string
  ringSpeeds?: [number, number, number]
}

export function RotatingSpeakersSemicircle({
  speakers,
  className = '',
  ringSpeeds = [20, 34, 48],
}: RotatingSpeakersSemicircleProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 flex items-center justify-center pointer-events-none z-[5]" style={{ bottom: 24, height: 120 }}>
      ...
      {/* Center title — positioned near bottom (ring center) */}
      <div className="absolute inset-x-0 flex justify-center pointer-events-none z-10" style={{ bottom: 48 }}>
        ...
        return (
          ...
          >
            {group.map((speaker, i) => {
              ...
              const delay = -(duration * i) / group.length
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    offsetRotate: '0deg',
                    animation: `ellipse-orbit-slide ${duration}s linear infinite`,
                ...
                >
                  {isLogo ? (
                    ...
                    <motion.div
                      layoutId={`speaker-semi-${speaker.id}`}
                      onClick={(e) => {
                        e.stopPropagation()
        ...
        {selectedSpeaker && (
          <>
            ...
            <div className="absolute inset-0 z-40 flex items-center justify-center pointer-events-none">
              <motion.div
                layoutId={`speaker-semi-${selectedSpeaker.id}`}
                onClick={handleDismiss}
